...
<body>
    <div style="max-width: 700px;margin: 0 auto;padding: 20px;text-align:center;font-size:14px">
        ...
        <p><strong> are invited to join the Work Around group!</strong> </p>
        <p>You have been invited to join the <strong>{{ $groupName }}</strong> group on Work Around!</p>
        <p>Group Code for join request:</p>
        <div style="width:fit-content;margin:20px auto;background-color: #000;color: #fff;padding: 5px 15px;font-size:20px; text-align: center;border-radius: 5px;">{{ $code }}</div>
        <hr>
