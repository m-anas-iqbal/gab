...
<body>
    <div style="max-width: 700px;margin: 0 auto;padding: 20px;text-align:center;font-size:14px">
        ...
        <p><strong> request for joinning {{ $group }} group  has been {{ $status }}.</strong></p>
        <p>Kindly login to portal check the group. Thank you for waiting.</p>
        {{-- <a href="{{ $inviteLink }}" style="text-decoration:none;width:fit-content;margin:20px auto;background-color: #000;color: #fff;padding: 5px 15px;font-size:20px; text-align: center;border-radius: 5px;" >{{ $inviteLink }}</a> --}}
        <hr>
